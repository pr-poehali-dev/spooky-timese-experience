...
const Index = () => {
  ...
  const kitPacks = [
    { name: 'КИТ NUTSONCIKA', price: '40₽', oldPrice: '99₽', discount: '-60%', emoji: '💎', color: 'from-purple-500 to-pink-500' },
    { name: 'КИТ АЛМАЗНЫЙ', price: '22₽', oldPrice: '55₽', discount: '-60%', emoji: '💠', color: 'from-cyan-500 to-blue-500' },
    { name: 'КИТ ЖЕЛЕЗКА', price: '10₽', oldPrice: '25₽', discount: '-60%', emoji: '⚙️', color: 'from-gray-400 to-gray-600' },
  ];

  const unbanPack = { name: 'РАЗБАН', price: '140₽', oldPrice: '349₽', discount: '-60%', emoji: '🔓', color: 'from-red-600 to-orange-600' };

  const videoRolls = [
    { name: '345.000 РИЛИКОВ', price: '10₽', oldPrice: '25₽', discount: '-60%', emoji: '🎬', color: 'from-pink-500 to-rose-500' },
    { name: '523.000 РИЛИКОВ', price: '14₽', oldPrice: '35₽', discount: '-60%', emoji: '🎥', color: 'from-violet-500 to-purple-500' },
    { name: '789.000 РИЛИКОВ', price: '18₽', oldPrice: '45₽', discount: '-60%', emoji: '📹', color: 'from-blue-500 to-indigo-500' },
    { name: '1.234.000 РИЛИКОВ', price: '22₽', oldPrice: '55₽', discount: '-60%', emoji: '🎞️', color: 'from-cyan-500 to-teal-500' },
    { name: '1.876.000 РИЛИКОВ', price: '26₽', oldPrice: '65₽', discount: '-60%', emoji: '📺', color: 'from-green-500 to-emerald-500' },
    { name: '2.543.000 РИЛИКОВ', price: '30₽', oldPrice: '75₽', discount: '-60%', emoji: '🎬', color: 'from-yellow-500 to-amber-500' },
    { name: '3.421.000 РИЛИКОВ', price: '34₽', oldPrice: '85₽', discount: '-60%', emoji: '🎥', color: 'from-orange-500 to-red-500' },
    { name: '4.567.000 РИЛИКОВ', price: '38₽', oldPrice: '95₽', discount: '-60%', emoji: '📹', color: 'from-fuchsia-500 to-pink-500' },
    { name: '5.789.000 РИЛИКОВ', price: '42₽', oldPrice: '105₽', discount: '-60%', emoji: '🎞️', color: 'from-purple-600 to-violet-600' },
    { name: '6.934.000 РИЛИКОВ', price: '50₽', oldPrice: '125₽', discount: '-60%', emoji: '📺', color: 'from-indigo-600 to-blue-600' },
    { name: '8.123.000 РИЛИКОВ', price: '58₽', oldPrice: '145₽', discount: '-60%', emoji: '🎬', color: 'from-sky-600 to-cyan-600' },
    { name: '9.456.000 РИЛИКОВ', price: '66₽', oldPrice: '165₽', discount: '-60%', emoji: '🎥', color: 'from-teal-600 to-green-600' },
    { name: '10.789.000 РИЛИКОВ', price: '74₽', oldPrice: '185₽', discount: '-60%', emoji: '📹', color: 'from-lime-600 to-yellow-600' },
    { name: '11.234.000 РИЛИКОВ', price: '82₽', oldPrice: '205₽', discount: '-60%', emoji: '🎞️', color: 'from-amber-600 to-orange-600' },
    { name: '12.565.000 РИЛИКОВ', price: '94₽', oldPrice: '235₽', discount: '-60%', emoji: '📺', color: 'from-red-600 to-rose-600' },
  ];
            ...
            <Card className="pixel-corners bg-[#4a3420] border-4 border-[#2d1f0f]">
              <CardContent className="p-8">
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  ...
                  <a
                    href="https://t.me/McRellyWorld"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="flex items-center gap-4 p-4 bg-[#0088cc] pixel-corners hover:scale-105 transition-transform"
                  >
                    <Icon name="Send" size={32} className="text-white" />
                    <div className="text-left">
                      <p className="font-bold text-white">Telegram</p>
                      <p className="text-xs text-gray-200">t.me/McRellyWorld</p>
                    </div>
                  </a>
                </div>
                <div className="mt-6 p-4 bg-black/30 pixel-corners">
                  <p className="text-sm text-gray-300">
                    По всем вопросам пишите в Discord или Telegram. Мы всегда на связи! 💬
                  </p>
                </div>
              </CardContent>
            </Card>
